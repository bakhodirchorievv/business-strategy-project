			...
			<div className="descriptor-wrapper">
				...
				<div className="first-part">
					...
					<div className="first-body">
						<img
							src="/business-strategy-project/MainPage/DescriptorFirst.png"
							alt=""
							className="first-body-img"
						/>
						<img
							src="/business-strategy-project/MainPage/DescriptorSecond.png"
							alt=""
							className="first-body-img"
						/>
						<img
							src="/business-strategy-project/MainPage/DescriptorThird.png"
							alt=""
							className="first-body-img"
						/>
					</div>
